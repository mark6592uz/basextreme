...
#define SIMPLE_COMPONENT_BEGIN(name) \
    ...
    public: \
        ...
        virtual const char* getComponentName() { return #name; } \
    }; \
...
#define SIMPLE_STATIC_COMPONENT_BEGIN(name) \
    extern EntityTypeInfo name##TypeInfo[]; \
    namespace ccor { \
        void registerStaticComponent(IComponent* component); \
    } \
    extern "C" __declspec(dllexport) IComponent * __cdecl coreInit##name##Component(); \
    class name##Component : public ccor::IComponent { \
    public: \
        name##Component() { ccor::registerStaticComponent(coreInit##name##Component()); } \
        virtual void __stdcall release() {} \
        virtual const char * __stdcall getComponentLabel() { return #name " v" PRODUCT_VERSION_LABEL " " __DATE__ " " __TIME__; } \
        virtual const EntityTypeInfo * __stdcall getTypeInfo() { return name##TypeInfo; } \
        virtual const char* getComponentName() { return #name; } \
